...
#ifdef CONFIG_ARIES_RMI4_F11_TYPEB
...
{
#ifdef	CONFIG_ARIES_RMI4_F11_PEN
...
#ifndef CONFIG_ARIES_RMI4_F11_PEN
...
#ifdef CONFIG_ARIES_RMI4_VIRTUAL_BUTTON
...
#ifdef CONFIG_ARIES_RMI4_F11_TYPEB
	if (f11->type_b)
		input_mt_init_slots(input, sensor->nbr_fingers, INPUT_MT_DIRECT);
#endif
#ifdef	CONFIG_ARIES_RMI4_F11_PEN
