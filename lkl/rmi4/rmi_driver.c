...
#ifndef CONFIG_ARIES_RMI4_FWLIB
				done = true;
#else
...
static int standard_suspend(struct rmi_device *rmi_dev)
{
	...
	if (data->suspended)
		goto exit;
			...
			defined(CONFIG_ARIES_RMI4_SPECIAL_EARLYSUSPEND)
	if (data->pre_suspend) {
...
#ifdef CONFIG_ARIES_RMI4_SPECIAL_EARLYSUSPEND
...
#endif /* CONFIG_HAS_EARLYSUSPEND */
#endif /* CONFIG_ARIES_RMI4_SPECIAL_EARLYSUSPEND */
